...
import getRecipe from "@salesforce/apex/SpoonacularRecipeController.getRecipeInformationById";

export default class SpoonacularRecipe extends LightningElement {
  @api image;
  @api title;
  @api price;
  @api time;
